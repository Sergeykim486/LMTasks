...
ru = {
    ...
    "changemydata": "✏️ Изменить мои данные",
    ...
    "breg": "📋 Регистрация",
    "errorcom": "⚠️ Не верная команда",
    "bsend": "📨 Отправить",
    "welcome": "Здравствуйте! Чем я могу помочь",
    "hi": "Я могу принять Вашу заявку и направить ее мастеру. Или принять от вас отзыв, пожелание или жалобу.",
    "by": "✅ Да",
    "bn": "⛔️ Нет",
    "lngsel": "Пожалуйста выберите язык",
    "enteragayn": "Пожалуйста введите все данные повторно. \n Выберите язык",
    "sname": "Имя:",
    "scname": "Наименование организации:",
    ...
    "contractifno": "Укажите номер долгосрочного договора если он есть. Если нет нажмите пропустить.",
    "bskip": "⏩ Пропустить",
    "bsave": "💾 Сохранить",
    "blang": "🇺🇿🇬🇧🇷🇺 Язык",
    "bcancel": "⛔️ Отмена",
...
uz = {
    ...
    "changemydata": "✏️ Ma'lumotlarimni o'zgartirish",
